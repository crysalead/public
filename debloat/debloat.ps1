...
'@
    ...
    if ($nonAdminLoggedOn -eq $false) {
        ...
        $starturl = "https://github.com/crysalead/public/raw/master/debloat/start2.bin"
    ...
    Start-Process -FilePath "taskkill" -ArgumentList "/im StartMenuExperienceHost.exe /f" -Wait
}
...
if ($manufacturer -like "*HP*") {
    ...
    if (test-path -Path 'C:\Program Files (x86)\InstallShield Installation Information\{6468C4A5-E47E-405F-B675-A70A70983EA6}\setup.exe') {
        invoke-webrequest -uri "https://raw.githubusercontent.com/crysalead/public/master/debloat/HPConnOpt.iss" -outfile "C:\Windows\Temp\HPConnOpt.iss"
...
if ($mcafeeinstalled -eq "true") {
    ...
    # Download Source
    $URL = 'https://github.com/crysalead/public/raw/master/debloat/mcafeeclean.zip'
    ...
    write-output "Downloading McAfee Removal Tool"
    # Download Source
    $URL = 'https://github.com/crysalead/public/raw/master/debloat/mccleanup.zip'
...
##Download the ODT
$odturl = "https://github.com/crysalead/public/raw/master/debloat/officedeploymenttool.exe"
$odtdestination = "C:\ProgramData\Debloat\officedeploymenttool.exe"
Invoke-WebRequest -Uri $odturl -OutFile $odtdestination -Method Get -UseBasicParsing

##Run it
Start-Process -FilePath "C:\ProgramData\Debloat\officedeploymenttool.exe" -ArgumentList "/configure C:\ProgramData\Debloat\o365.xml" -Wait
